...
def generate_data(simulator = None, dataset = 1, num_agent=1, seed = 0):
    ...
    for i in range(0,1,1):
        ...
        # init_probability[:num_probabilities] = 0.5
        # init_probability[-3] = 5 # m
        # init_probability[-2] = 2.5 # c
        # init_probability[-1] = 0.25
        ...
        try:
            p, global_cost, _, ft, ut, _, _ , _, conwait, _= output
            p = np.array(p)
